...
public class TestMyFlickrAppBB36{

	static int picXpage = 1;

	static String apiKey = "f7a8afe0915a11f3336995f3f8c0ec38";
    static String sharedSecret = "7843f16356a2bed2";
     ...
     try
        {
         ...
         TestMyFlickrAppBB36 tfa = new TestMyFlickrAppBB36();

         Locations l = Locations.OCLAHOMA;
