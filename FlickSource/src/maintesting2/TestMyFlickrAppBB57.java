...
public class TestMyFlickrAppBB57{

	static int picXpage = 1;

	static String apiKey = "647001b9947b094c25c466575e5fca9d";
    static String sharedSecret = "3c83ef9de7498eb6";
     ...
     try
        {
         ...
         TestMyFlickrAppBB57 tfa = new TestMyFlickrAppBB57();

         Locations l = Locations.INDIANAPOLIS;
