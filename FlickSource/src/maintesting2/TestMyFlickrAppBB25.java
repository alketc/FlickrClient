...
public class TestMyFlickrAppBB25{

	static int picXpage = 1;

	static String apiKey = "56cb5986b09e1644be3a6cd220aa5ce7";
    static String sharedSecret = "f5957820d333c924";
     ...
     try
        {
         ...
         TestMyFlickrAppBB25 tfa = new TestMyFlickrAppBB25();

         Locations l = Locations.SANFRANCISCO;
