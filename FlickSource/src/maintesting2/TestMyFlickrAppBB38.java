...
public class TestMyFlickrAppBB38{

	static int picXpage = 1;

	static String apiKey = "eee8a14b63139c424c9f69c5ed4745a9";
    static String sharedSecret = "68f4cd6bae796f53";
     ...
     try
        {
         ...
         TestMyFlickrAppBB38 tfa = new TestMyFlickrAppBB38();

         Locations l = Locations.RONNE;
