...
public class TestMyFlickrAppBB54{

	static int picXpage = 1;

    
    static String apiKey = "48c8e893113a0ee03a52f8b26fdafd4a";

    static String sharedSecret = "62a8032567e5ce25";
     ...
     try
        {
         ...
         TestMyFlickrAppBB54 tfa = new TestMyFlickrAppBB54();

         Locations l = Locations.FRANCOFORTE;
