...
public class TestMyFlickrAppBB45{

	static int picXpage = 1;

	static String apiKey = "ca5b404289d46bfb06763ed781fb3b3e";
    static String sharedSecret = "43fd394f444da6f8";
     ...
     try
        {
         ...
         TestMyFlickrAppBB45 tfa = new TestMyFlickrAppBB45();

         Locations l = Locations.KANSAS;
