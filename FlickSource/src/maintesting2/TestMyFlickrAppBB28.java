...
public class TestMyFlickrAppBB28{

	static int picXpage = 1;

	static String apiKey = "f26e0eb222504d265b29f12b0f6f2a43";
    static String sharedSecret = "90a4e36d4b5ccccf"; 
     ...
     try
        {
         ...
         TestMyFlickrAppBB28 tfa = new TestMyFlickrAppBB28();

         Locations l = Locations.HOBART;
