...
public class TestMyFlickrAppBB22{

	static int picXpage = 1;

	static String apiKey = "cb10a33b2a9d132e55d830584ab19ecd";
    static String sharedSecret = "0dd67206db52cea9";
     ...
     try
        {
         ...
         TestMyFlickrAppBB22 tfa = new TestMyFlickrAppBB22();

         Locations l = Locations.SALTLAKE;
