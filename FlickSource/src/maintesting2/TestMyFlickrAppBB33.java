...
public class TestMyFlickrAppBB33{

	static int picXpage = 1;

	static String apiKey = "46f301d5947bc6c85ea04ced9acfa645";
    static String sharedSecret = "3864bea196024c3e";
     ...
     try
        {
         ...
         TestMyFlickrAppBB33 tfa = new TestMyFlickrAppBB33();

         Locations l = Locations.CAMPANIA;
