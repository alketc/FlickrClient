...
public class TestMyFlickrAppBB48{

	static int picXpage = 1;

	static String apiKey = "96cb355cff182e18f42cc015a6f8af37";
    static String sharedSecret = "be942b052e1b580d";
     ...
     try
        {
         ...
         TestMyFlickrAppBB48 tfa = new TestMyFlickrAppBB48();

         Locations l = Locations.MIAMI;
