...
public class TestMyFlickrAppBB32{

	static int picXpage = 1;

	static String apiKey = "d01f015180fb38943a0dbc34c1acca50";
    static String sharedSecret = "2b4d1cf5e6ea1f0a";
     ...
     try
        {
         ...
         TestMyFlickrAppBB6 tfa = new TestMyFlickrAppBB6();

         Locations l = Locations.MINNEAPOLIS;
...
//      list.add(10);
   ...
   //   list.add(22);
     ...
     // list.add(23);
      ...
      for(int month=0; month< month_end; month++){
