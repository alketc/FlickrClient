...
public class TestMyFlickrAppBB21{

	static int picXpage = 1;

	static String apiKey = "884d3e05f43cfa4dc7040493b1d5225a";
    static String sharedSecret = "65c43ffa807e2d2d";
     ...
     try
        {
         ...
         TestMyFlickrAppBB21 tfa = new TestMyFlickrAppBB21();

         Locations l = Locations.HOSHIMIN;
