...
public class TestMyFlickrAppBB6{

	static int picXpage = 1;

	static String apiKey = "123ba0e00f225e7b6915cb3cda6f4e52";
    static String sharedSecret = "3ed674c267d4edb4";
     ...
     try
        {
         ...
         Locations l = Locations.SAINTLUIS;
