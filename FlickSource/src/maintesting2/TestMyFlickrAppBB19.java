...
public class TestMyFlickrAppBB19{

	static int picXpage = 1;

//	static String apiKey = "56e6834c2703840c6954743776d7dd0f";
//    static String sharedSecret = "14a2e1c882b64371";
    

    
    static String apiKey = "9dac2f370467a631827bdb5d557acdbf";

    static String sharedSecret = "3f86aea38142fef7";
     ...
     try
        {
         ...
         TestMyFlickrAppBB19 tfa = new TestMyFlickrAppBB19();

         Locations l = Locations.DRESDA;
