...
public class TestMyFlickrAppBB47{

	static int picXpage = 1;

	
 
    static String apiKey = "01d531c72db5286db235c6d75eb1c578";


    static String sharedSecret = "ad95327273c93a61";
     ...
     try
        {
         ...
         TestMyFlickrAppBB47 tfa = new TestMyFlickrAppBB47();

         Locations l = Locations.LASPALMAS;
