...
public class TestMyFlickrAppBB50{
    ...
    static String apiKey = "86383e3a1b29730d560d680b9d5cf70c";


    static String sharedSecret = "02649ffdca59a1e9";
     ...
     try
        {
         ...
         TestMyFlickrAppBB50 tfa = new TestMyFlickrAppBB50();

         Locations l = Locations.ATALANTA;
