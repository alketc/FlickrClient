...
public class TestMyFlickrAppBB24{

	static int picXpage = 1;

	static String apiKey = "fcadad316c482a8f3cce81b7b75fd654";
    static String sharedSecret = "8c6a438d893fc666";
     ...
     try
        {
         ...
         TestMyFlickrAppBB24 tfa = new TestMyFlickrAppBB24();

         Locations l = Locations.JEJU;
