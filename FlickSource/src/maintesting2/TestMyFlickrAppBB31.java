...
public class TestMyFlickrAppBB31{

	static int picXpage = 1;


//    
    static String apiKey = "393356194bd5c3cbf70ae9920cf28972";
    static String sharedSecret = "c9e462627c47e487";
    ...
    public TestMyFlickrAppBB31()
      throws ParserConfigurationException, IOException {
        f = new Flickr(apiKey,sharedSecret,new REST());
        requestContext = RequestContext.getRequestContext();
    }
	
    public void showActivityBB(String city, double v1x, double v1y,double v3x, double v3y,Calendar start, 
    		                                               Calendar end, String output_file) throws IOException {
     ...
     try
        {
         ...
         TestMyFlickrAppBB31 tfa = new TestMyFlickrAppBB31();

         Locations l = Locations.ZURIGO;
   ...
   //   list.add(23);
    ...
    // list.add(26);
      ...
      for(int year = 0; year < yearlist.size(); year++){
    	  int month_end = 12;
      	if(yearlist.get(year) == 2014) month_end = 8;
