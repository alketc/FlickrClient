...
public class TestMyFlickrAppBB2{

	static int picXpage = 1;

	static String apiKey = "1406c85f12e921c51a7bd78f4408fe8d";
    static String sharedSecret = "339f96f4396941c3";
     ...
     try
        {
         ...
         TestMyFlickrAppBB2 tfa = new TestMyFlickrAppBB2();
