...
public class TestMyFlickrAppBB52{

	static int picXpage = 1;

	
    
    static String apiKey = "7d5eab93c19b5c3df9565388fc71017e";

    static String sharedSecret = "2b7a7121974a218d";
    
    Flickr f;
    REST rest;
    RequestContext requestContext;
    
    public TestMyFlickrAppBB52()
     ...
     try
        {
         ...
         TestMyFlickrAppBB52 tfa = new TestMyFlickrAppBB52();

         Locations l = Locations.DUBLINO;
