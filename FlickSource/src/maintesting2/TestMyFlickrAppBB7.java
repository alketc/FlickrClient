...
public class TestMyFlickrAppBB7{

	static int picXpage = 1;

	static String apiKey = "c040767aec149c612bdacb8ec6824ee9";
    static String sharedSecret = "27e83a26c9a47d48";
     ...
     try
        {
         ...
         TestMyFlickrAppBB7 tfa = new TestMyFlickrAppBB7();

         Locations l = Locations.ISLANDA;
