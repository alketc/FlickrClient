...
public class TestMyFlickrAppBB5{

	static int picXpage = 1;

	static String apiKey = "b2858631df221ab02e6d7a00b12415b5";
    static String sharedSecret = "01b5e780223653d9";
     ...
     try
        {
         ...
         TestMyFlickrAppBB5 tfa = new TestMyFlickrAppBB5();

         Locations l = Locations.GINEVRA;
