...
public class TestMyFlickrAppBB4{

	static int picXpage = 1;


    
    static String apiKey = "584249e19331e41ac2ba4bd4ddf4e746";

    static String sharedSecret = "098316a438b45405";
