...
public class TestMyFlickrAppBB56{

	static int picXpage = 1;


    
    static String apiKey = "ade88df07d8556348195cdc413084e29";

    static String sharedSecret = "902cb1f195e5140d";
     ...
     try
        {
         ...
         TestMyFlickrAppBB56 tfa = new TestMyFlickrAppBB56();

         Locations l = Locations.MARSIGLIA;
