...
public class TestMyFlickrAppBB49{

	static int picXpage = 1;

	static String apiKey = "bd30ea1f81869fc06ff69ccc3403e060";
    static String sharedSecret = "bf7d6a4c08c80636";
     ...
     try
        {
         ...
         TestMyFlickrAppBB49 tfa = new TestMyFlickrAppBB49();

         Locations l = Locations.PHOENIX;
