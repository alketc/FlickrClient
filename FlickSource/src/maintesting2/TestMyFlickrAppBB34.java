...
public class TestMyFlickrAppBB34{

	static int picXpage = 1;

	static String apiKey = "fb5d9288c911e9624afec8c67af42bbe";
    static String sharedSecret = "f8df321b84c775c8";
     ...
     try
        {
         ...
         TestMyFlickrAppBB34 tfa = new TestMyFlickrAppBB34();

         Locations l = Locations.ZARAGOZA;
