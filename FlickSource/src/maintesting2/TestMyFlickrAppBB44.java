...
public class TestMyFlickrAppBB44{

	static int picXpage = 1;

	static String apiKey = "edb60ec39fd0658ccb3690566ef7b214";
    static String sharedSecret = "bc03bd149a448704";
     ...
     try
        {
         ...
         TestMyFlickrAppBB44 tfa = new TestMyFlickrAppBB44();

         Locations l = Locations.ANTWERP;
