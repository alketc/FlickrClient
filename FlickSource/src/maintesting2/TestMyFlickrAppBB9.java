...
public class TestMyFlickrAppBB9{

	static int picXpage = 1;

	static String apiKey = "ddc0edc3448f531112300c786e641338";
    static String sharedSecret = "aff8e14d90a7a42a";
    
    Flickr f;
    REST rest;
    RequestContext requestContext;
    
    public TestMyFlickrAppBB9()
     ...
     try
        {
         ...
         TestMyFlickrAppBB9 tfa = new TestMyFlickrAppBB9();

         Locations l = Locations.SEATLE;
