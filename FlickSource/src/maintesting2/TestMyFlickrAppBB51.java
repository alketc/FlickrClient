...
public class TestMyFlickrAppBB51{

	static int picXpage = 1;

	static String apiKey = "87f1403b35ceab3a91ea0ff929c6664c";
    static String sharedSecret = "1fbd2df0540989d8";
     ...
     try
        {
         ...
         TestMyFlickrAppBB51 tfa = new TestMyFlickrAppBB51();

         Locations l = Locations.COLONIA;
