...
public class TestMyFlickrAppBB39{

	static int picXpage = 1;

	static String apiKey = "5c22126995b3ec26501b65332f0df359";
    static String sharedSecret = "48000287157d76de";
     ...
     try
        {
         ...
         TestMyFlickrAppBB39 tfa = new TestMyFlickrAppBB39();
