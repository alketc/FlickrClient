...
public class TestMyFlickrAppBB20{

	static int picXpage = 1;
//
//	static String apiKey = "2dc804f9cddd0b70d99f3b07cdf75dfb";
//    static String sharedSecret = "09c453988cff8d94";
   
    
    
    

    static String apiKey = "fb79447527a0c0c222b2f5643f0bb0e2";

    static String sharedSecret = "2e7fe0f15b4246ba";
     ...
     try
        {
         ...
         TestMyFlickrAppBB20 tfa = new TestMyFlickrAppBB20();

         Locations l = Locations.MESSICOC;
   	  ...
   	  //  list.add(20);
   	   ...
   	   // list.add(23);
   	    ...
   	    for(int year = 0; year < yearlist.size(); year++){
   	    	int monthend = 12;
   	    	if(yearlist.get(year) == 2014) monthend = 7;
