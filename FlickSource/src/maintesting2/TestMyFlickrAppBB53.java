...
public class TestMyFlickrAppBB53{
    ...
    static String apiKey = "8542197e4379cc65596f3d0833f69952";

    static String sharedSecret = "435f90f40c2995b7";
     ...
     try
        {
         ...
         TestMyFlickrAppBB53 tfa = new TestMyFlickrAppBB53();

         Locations l = Locations.EDINBURG;
