...
public class TestMyFlickrAppBB35{

	static int picXpage = 1;

	static String apiKey = "95c005feb771d591a8b50bd96acc61f9";
    static String sharedSecret = "837eb6c7aa4e58a1";
     ...
     try
        {
         ...
         TestMyFlickrAppBB35 tfa = new TestMyFlickrAppBB35();
   ...
   //   list.add(22);
     ...
     // list.add(23);
      ...
      for(int year = 0; year < yearlist.size(); year++){
      	int endmonth = 12;
      	if(yearlist.get(year) == 2014) endmonth = 8;
