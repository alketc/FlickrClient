...
public class TestMyFlickrAppBB23{

	static int picXpage = 1;

	static String apiKey = "8d67a3845228ce0fc8bbd32894f2c3b1";
    static String sharedSecret = "a09478662dd6a451";
     ...
     try
        {
         ...
         TestMyFlickrAppBB23 tfa = new TestMyFlickrAppBB23();

         Locations l = Locations.XIAN;
