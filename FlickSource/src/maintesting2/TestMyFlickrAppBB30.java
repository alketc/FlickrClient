...
public class TestMyFlickrAppBB30{

	static int picXpage = 1;

	static String apiKey = "3f93f9b6af6827c2ca10fb4d7ac468fe";
    static String sharedSecret = "3e9847cac7153d30";
     ...
     try
        {
         ...
         TestMyFlickrAppBB30 tfa = new TestMyFlickrAppBB30();

         Locations l = Locations.TALIN;
      ...
      for(int month=0; month<monthend; month++){
      	...
      	for(int day = 0; day < list.size(); day++){
      		...
      		tfa.showActivityBB(city,l.getV1x() , l.getV1y() ,l.getV3x(), l.getV3y(),
      				...
      				new GregorianCalendar(yearlist.get(year),month,list.get(day+1),0,59,59),
