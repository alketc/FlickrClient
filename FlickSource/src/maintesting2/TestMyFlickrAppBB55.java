...
public class TestMyFlickrAppBB55{

	static int picXpage = 1;

    static String apiKey = "1accf1e169f0b9f60256c0614fb0b841";
    static String sharedSecret = "ce063cf22d4ca254";
     ...
     try
        {
         ...
         TestMyFlickrAppBB55 tfa = new TestMyFlickrAppBB55();

         Locations l = Locations.HAMBURG;
