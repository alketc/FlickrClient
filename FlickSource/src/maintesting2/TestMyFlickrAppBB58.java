...
public class TestMyFlickrAppBB58{

	static int picXpage = 1;



    static String apiKey = "dc3cc995fd2b04d60314d1063054ba7e";
    static String sharedSecret = "c580d9b4abb63697";
     ...
     try
        {
         ...
         TestMyFlickrAppBB58 tfa = new TestMyFlickrAppBB58();

         Locations l = Locations.INVERNEES;
