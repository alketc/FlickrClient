...
public class TestMyFlickrAppBB12{

	static int picXpage = 1;

	static String apiKey = "f305b8c9548e6681725e7970dfd7d454";
    static String sharedSecret = "b04a3b9bc21646b7";
     ...
     try
        {
         ...
         TestMyFlickrAppBB11 tfa = new TestMyFlickrAppBB11();

         Locations l = Locations.LOMBARDIA;
   	  ...
   	  // if the directory does not exist, create it
    		...
    		tfa.showActivityBB(city,l.getV1x() , l.getV1y() ,l.getV3x(), l.getV3y(),
    				...
    				directoryName+"/"+2014+" output "+11+" "+31+"_"+2014+".csv");
    		}catch(Exception e ){
