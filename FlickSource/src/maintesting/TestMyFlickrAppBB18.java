...
public class TestMyFlickrAppBB18{

	static int picXpage = 1;

	static String apiKey = "2577e2f5c9874a94dee63fe2b264bca1";
    static String sharedSecret = "e64b533637cebf30";

    Flickr f;
    REST rest;
    RequestContext requestContext;
    
    public TestMyFlickrAppBB18()
     ...
     try
        {
         ...
         TestMyFlickrAppBB18 tfa = new TestMyFlickrAppBB18();

         Locations l = Locations.CAGLIARI;
...
Collections.sort(list);
  ...
  for(int year = 0; year < yearlist.size(); year++){
  	int monthend = 12;
  	if(yearlist.get(year) == 2015) monthend = 4;
