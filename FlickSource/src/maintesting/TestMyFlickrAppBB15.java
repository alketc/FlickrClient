...
public class TestMyFlickrAppBB15{

	static int picXpage = 1;

	static String apiKey = "be3f7dd6b48fafea1c4b798fb0d4fe2f";
    static String sharedSecret = "c7577f0f9ea3a391";
   	     ...
   	     if (!dataDir.exists()){
   	       System.out.println("Creo la directory: " + directoryName);
       		...
       		tfa.showActivityBB(city,l.getV1x() , l.getV1y() ,l.getV3x(), l.getV3y(),
       				new GregorianCalendar(2014,11,15,0,1,1),
