...
public class TestMyFlickrAppBB13{

	static int picXpage = 1;

	static String apiKey = "bf50b7e48a56a2ede25cb81be3e3ad0b";
    static String sharedSecret = "e164b6e5f26e51b8";
     ...
     try
        {
         ...
         TestMyFlickrAppBB13 tfa = new TestMyFlickrAppBB13();

         Locations l = Locations.LAZIO;
