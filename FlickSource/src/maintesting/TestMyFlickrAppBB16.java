...
public class TestMyFlickrAppBB16{

	static int picXpage = 1;

	static String apiKey = "cefeb504533a9bd8f70efbfef6593202";
    static String sharedSecret = "116f0a726a94b876";
     ...
     try
        {
         ...
         TestMyFlickrAppBB16 tfa = new TestMyFlickrAppBB16();

         Locations l = Locations.FIRENZE;
   	     ...
   	     if (!dataDir.exists()){
   	       System.out.println("Creo la directory: " + directoryName);
       		...
       		tfa.showActivityBB(city,l.getV1x() , l.getV1y() ,l.getV3x(), l.getV3y(),
       				...
       				directoryName+"/"+2014+"---output "+17+" "+31+"_"+2014+".csv");
       		}catch(Exception e ){
