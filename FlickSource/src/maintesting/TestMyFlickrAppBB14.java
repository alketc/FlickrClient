...
public class TestMyFlickrAppBB14{

	static int picXpage = 1;

	static String apiKey = "2527108483f6e0d2a283f30dc75c7e1b";
    static String sharedSecret = "d554b29a33ed9572";

    Flickr f;
    REST rest;
    RequestContext requestContext;
    
    public TestMyFlickrAppBB14()
     ...
     try
        {
         ...
         TestMyFlickrAppBB14 tfa = new TestMyFlickrAppBB14();

         Locations l = Locations.MARCHE;
   	  ...
   	  // if the directory does not exist, create it
    		...
    		tfa.showActivityBB(city,l.getV1x() , l.getV1y() ,l.getV3x(), l.getV3y(),
    				...
    				directoryName+"/"+17+"---output "+31+" "+2014+"_"+29014+".csv");
    		}catch(Exception e ){
