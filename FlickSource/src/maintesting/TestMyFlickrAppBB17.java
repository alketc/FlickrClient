...
public class TestMyFlickrAppBB17{

	static int picXpage = 1;

	static String apiKey = "d8f7d16a209f2236ef9327cc00557bf6";
    static String sharedSecret = "0742589869b7dac3";
     ...
     try
        {
         ...
         TestMyFlickrAppBB17 tfa = new TestMyFlickrAppBB17();

         Locations l = Locations.GENOVA;
